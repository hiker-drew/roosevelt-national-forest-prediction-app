...
with col2:
    ...
    **7. Krummholz**  
    ...
    At alpine elevations with harsh and icy winds, trees become a krummholz form where they grow in flag shapes sculpted by the wind or are found being protected behind rocks.
""")
