...
if st.button("Predict Forest Type", type="primary", use_container_width=True):
    ...
    if model is not None:
        try:
            ...
            st.error(f"❌ Error during prediction: {stimport streamlit as st
import pickle
import pandas as pd
import numpy as np
import os
...
st.markdown("- Project Repository: https://github.com/hiker-drew/roosevelt-national-forest-prediction-app")r(e)}")
