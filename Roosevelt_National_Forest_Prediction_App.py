...
with col2:
    ...
    **5. Aspen**  
    ...
    Deciduous trees that grow in large clonal colonies connected by shared root systems, making each grove a single organism. Pioneer species requiring abundant sunshine, quickly colonizing burned areas.
